...
class MainActivity : AppCompatActivity() {
    ...
    private fun veriKaynagiHazirla() {
        ...
        var burcSembolleri = arrayOf(
            R.drawable.koc1, R.drawable.boga2, R.drawable.ikizler3
        ...
        var burcBuyukResimleri = arrayOf(
            R.drawable.b_koc1, R.drawable.b_boga2, R.drawable.b_ikizler3
        ...
        for (i in 0..11) {
            var arrayListEklenecekBurc = Burc(burcAdlari[i],burcTarihleri[i],burcSembolleri[i],burcBuyukResimleri[i])
